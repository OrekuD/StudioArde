...
export default function Hero(props: Props) {
  ...
  const text1TranslateX = useTransform(
    scrollY,
    [0, window.innerHeight / 2],
    ["0%", "-130%"]
  );

  const text2TranslateX = useTransform(
    scrollY,
    [0, window.innerHeight / 2],
    ["0%", "130%"]
  );
